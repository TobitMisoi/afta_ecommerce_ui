...
import { signup } from '@/services/afta/api';
...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      //
      const msg: any = await signup({ ...values });
console.log(msg)
      ...
      if (msg) {
        ...
        const defaultLoginSuccessMessage = intl.formatMessage({
          ...
          defaultMessage: 'Signup successful',
        });
    ...
    <div className={containerClassName}>
      ...
      >
        ...
        >
          ...
          >
           <ProFormCheckbox noStyle name='privacy'>
              Private
            </ProFormCheckbox>
            <Link
              to='/user/login'
